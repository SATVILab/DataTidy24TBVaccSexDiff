...
summed_response <- data_tidy_vacc_freq |>
...
```{r}
library(ggplot2)
summed_response$timepoint <- as.factor(summed_response$timepoint)

#plot
ggplot(summed_response, aes(x = ptid, y = total_response, fill = timepoint)) +
